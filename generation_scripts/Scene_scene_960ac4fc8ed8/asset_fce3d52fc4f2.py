...
GENERATION = {
  "object_id": "asset_fce3d52fc4f2",
  "asset_id": "asset_fce3d52fc4f2",
  "category": "object",
  ...
  "material_color": null,
  "source_prompt": "Replace the current table with a round table that has a circular top; four individual legs",
