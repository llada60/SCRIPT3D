# **SCRIPT3D**: 3D A**s**set-**C**ontrolled **R**eproducible P**i**peline and **T**ooling

SCRIPT3D is a **code-based multi-agent system for controllable 3D asset generation and editing in Blender**. It turns natural-language requests into explicit Python generation scripts.
...
<img src="pic_readme/motivation.png">
...
<img src="pic_readme/highlight.png" alt="Pipeline Diagram">
...
<img src="pic_readme/teaser.png" alt="Pipeline Diagram">
